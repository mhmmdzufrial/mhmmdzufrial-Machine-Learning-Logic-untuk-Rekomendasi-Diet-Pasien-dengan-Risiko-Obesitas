...
.stApp {
  ...
  color: black; /* Set general text color to black */
}
.st-emotion-cache-zt5ig8 { /* Targeting the main content area */
    background-color: white;
    color: black; /* Set text color to black for main content */
}
.st-emotion-cache-gh2jqd { /* Targeting the sidebar content area */
    background-color: white;
    color: black; /* Set text color to black for sidebar */
}
/* Ensure all common text elements are black for readability */
p, div, span, h1, h2, h3, h4, h5, h6, label, .stMarkdown, .stSelectbox > label, .stNumberInput > label, .stTextInput > label {
